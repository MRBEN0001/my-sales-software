...
<script>
    ...
    $(function () {
        ...
        // ✅ Auto-calculate when discount or received value changes
        $(document).on('input', '#diskon, #diterima', function () {
            if ($(this).val() == "") {
                $(this).val(0).select();
            }
